# Propuesta de rediseño de la web (lienzo de diseño)
...
No forman parte del sitio publicado (`docs/`). Cuando se apruebe la dirección, la
implementación real irá en `docs/index.html`.
